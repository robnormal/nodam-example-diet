...
(function() {
  var DELETE, GET, M, POST, PUT, actions, createFood, createIngredient, createMealFood, dbAll, dbFunction, dbGet, dbM, dbRun, deleteFood, deleteIngredient, deleteMealFood, display, error403, error404, fmap, foodUrl, fs, getIngredients, getJade, getPost, getView, helper, jade, matchUrl, mealUrl, model, nodam, orm, qs, queries, redirect, routeRequest, routes, runQuery, setMealCals, showMonadErr, showView, sql, success, updateFood, updateMealFood, uriToWord, wordToUri, _,
    __slice = [].slice;
