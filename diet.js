...
(function() {
  var Async, DELETE, GET, M, POST, PUT, R, actions, addIngredient, addMealToPlan, apology, createFood, createMealFood, createPlan, db, dbM, deleteIngredient, fmap, foodUrl, fs, getLatestMeal, jade, logError, mealUrl, mimeTypes, nodam, orm, path, planUrl, qs, queries, removeMealFromPlan, routes, serveFile, sql, toInt, updateFood, updateIngredient, updateMealFood, web, _;
        ...
        if (post['delete']) {
          ...
          return db.get(queries.plans + orm.condition({
            ...
            if (post.rename && post.plan_name) {
              ...
              return db.reorderPlanMeals(plan, post.ids).then(web.success('OK'));
            } else {
